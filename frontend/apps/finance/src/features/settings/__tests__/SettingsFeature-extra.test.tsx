...
function renderSettings() {
  return render(
    <MemoryRouter>
      <SettingsFeature user={mockUser} onUserUpdated={vi.fn()} />
    </MemoryRouter>,
  );
}

describe("SettingsFeature - Tags delete and edit cancel", () => {
  beforeEach(() => {
    mockFetch.mockReset();
  });
...
describe("SettingsFeature - Mobile accordion", () => {
  beforeEach(() => {
    mockFetch.mockReset();
  });
  ...
  it("calls onUserUpdated when profile update succeeds", async () => {
    ...
    render(
      <MemoryRouter>
        <SettingsFeature user={mockUser} onUserUpdated={onUserUpdated} />
      </MemoryRouter>,
    );
