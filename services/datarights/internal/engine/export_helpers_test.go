	...
	return []*expensepb.ExpenseListResponse{
		{
			Data: []*expensepb.ExpenseData{
				{
					Id: "exp-1", Name: "Groceries", OriginalTransactionAmountInMinorUnits: 4599, TransactionCurrencyCode: "USD",
					ExpenseType: "essentials", TagId: "tag-1", ExpenseDateIso: "2026-05-01",
					PeriodYear: 2026, PeriodMonth: 5, Status: "active",
					CreatedAt:                   "2026-05-01T12:00:00Z",
					ReportingAmountInMinorUnits: 4599, ReportingCurrencyCode: "USD",
					SourceToTargetExchangeRate: "1", ExchangeRateSource: exchangesource.Identity, ExchangeRateTimestamp: "2026-05-01T12:00:00Z",
				},
				{
					Id: "exp-2", Name: "Bus pass", OriginalTransactionAmountInMinorUnits: 3000, TransactionCurrencyCode: "USD",
					ExpenseType: "essentials", TagId: "tag-2", ExpenseDateIso: "2026-05-02",
					PeriodYear: 2026, PeriodMonth: 5, Status: "active",
					CreatedAt:                   "2026-05-02T09:00:00Z",
					ReportingAmountInMinorUnits: 3000, ReportingCurrencyCode: "USD",
					SourceToTargetExchangeRate: "1", ExchangeRateSource: exchangesource.Identity, ExchangeRateTimestamp: "2026-05-02T09:00:00Z",
				},
			},
			HasMore: false,
		},
