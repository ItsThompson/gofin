			...
			Data: []*expensepb.ExpenseData{
				{
					...
					TransactionCurrency: "USD", MoneySnapshotVersion: 1,
					TransactionAmount: 4599, ReportingAmount: 4599, ReportingCurrency: "USD",
				...
				},
				{
					...
					TransactionCurrency: "USD", MoneySnapshotVersion: 1,
					TransactionAmount: 3000, ReportingAmount: 3000, ReportingCurrency: "USD",
