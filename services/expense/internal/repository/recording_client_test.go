...
func expensesToSQLResult(expenses []*model.Expense) *SQLResult {
	...
	for _, e := range expenses {
		rows = append(rows, SQLRow{Values: []SQLValue{
			...
			fakeSQLValue{stringValue: e.ExpenseDateIso},
			...
			fakeSQLValue{intValue: e.OriginalTransactionAmountInMinorUnits},
			fakeSQLValue{stringValue: e.TransactionCurrencyCode},
			fakeSQLValue{intValue: e.ReportingAmountInMinorUnits},
			fakeSQLValue{stringValue: e.ReportingCurrencyCode},
			fakeSQLValue{stringValue: e.SourceToTargetExchangeRate},
			fakeSQLValue{stringValue: e.ExchangeRateSource},
			fakeSQLValue{stringValue: e.ExchangeRateTimestamp},
			fakeSQLValue{stringValue: e.ExchangeRateCacheExpiresAt},
