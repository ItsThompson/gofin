...
type GetActiveExpensesForPeriodRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        string                 `protobuf:"bytes,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
...
func (x *GetActiveExpensesForPeriodRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetActiveExpensesForPeriodRequest) GetYear() int32 {
	if x != nil {
		return x.Year
	}
	return 0
...
func (x *GetActiveExpensesForPeriodRequest) GetMonth() int32 {
	if x != nil {
		return x.Month
	}
	return 0
...
func (x *GetActiveExpensesForPeriodRequest) GetPage() int32 {
	if x != nil {
		return x.Page
	}
	return 0
...
func (x *GetActiveExpensesForPeriodRequest) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
const file_proto_expense_proto_rawDesc = "" +
	...
	"\x16captured_rate_snapshot\x18\f \x01(\v2\x1d.expense.CapturedRateSnapshotR\x14capturedRateSnapshot\"\x97\x01\n" +
	"!GetActiveExpensesForPeriodRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x12\n" +
